 ...
 *
 *$Id: libgte.h,v 1.33 1997/05/07 06:54:04 oka Exp $
 */
 ...
 * GTE store macros
 */
#define store_sxsy_fifo3(r1, r2, r3)                                           \
    swc2 $12, (r1);                                                            \
    swc2 $13, (r2);                                                            \
    swc2 $14, (r3);                                                            \
    nop

#define store_sxsy0(r1)                                                        \
    swc2 $12, (r1);                                                            \
    nop

#define store_sxsy1(r1)                                                        \
    swc2 $13, (r1);                                                            \
    nop

#define store_sxsy2(r1)                                                        \
    swc2 $14, (r1);                                                            \
    nop

#define store_rgb_fifo(r1, r2, r3)                                             \
    swc2 $20, (r1);                                                            \
    swc2 $21, (r2);                                                            \
    swc2 $22, (r3);                                                            \
    nop

#define store_rgb0(r1)                                                         \
    swc2 $20, (r1);                                                            \
    nop

#define store_rgb1(r1)                                                         \
    swc2 $21, (r1);                                                            \
    nop

#define store_rgb2(r1)                                                         \
    swc2 $22, (r1);                                                            \
    nop
...
extern long RotTransPers3(SVECTOR* v0, SVECTOR* v1, SVECTOR* v2, long* sxy0,
                          long* sxy1, long* sxy2, long* p, long* flag);
...
extern void DpqColor3(CVECTOR* v0, CVECTOR* v1, CVECTOR* v2, long p,
...
extern u_long *GsTMDfastTF4LM(TMD_P_TF4 *primtop,SVECTOR *vertop,
        SVECTOR *nortop, POLY_FT4 *s,u_long n,u_long shift,GsOT *otp);
extern u_long *GsTMDfastTF4LFGM(TMD_P_TF4 *primtop,SVECTOR *vertop,
        SVECTOR *nortop,POLY_FT4 *s,u_long n,u_long shift,GsOT *otp);
extern u_long *GsTMDfastTF4NLM(TMD_P_TF4 *primtop,SVECTOR *vertop,
        SVECTOR *nortop,POLY_FT4 *s,u_long n,u_long shift,GsOT *otp);
extern u_long *GsTMDfastTNF4M(TMD_P_TNF4 *primtop,SVECTOR *vertop,
        POLY_FT4 *s,u_long n,u_long shift,GsOT *otp);
...
extern u_long *GsTMDfastTG3L_FLIP(TMD_P_TG3 *primtop,SVECTOR *vertop,SVECTOR
*nortop, POLY_GT3 *s,u_long n,u_long shift,GsOT *otp); extern u_long
*GsTMDfastTG3LFG_FLIP(TMD_P_TG3 *primtop,SVECTOR *vertop, SVECTOR
*nortop,POLY_GT3 *s,u_long n,u_long shift,GsOT *otp); extern u_long
*GsTMDfastTG3NL_FLIP(TMD_P_TG3 *primtop,SVECTOR *vertop, SVECTOR
*nortop,POLY_GT3 *s,u_long n,u_long shift,GsOT *otp); extern u_long
*GsTMDfastTNG3_FLIP(TMD_P_TNG3 *primtop,SVECTOR *vertop, POLY_GT3 *s,u_long
n,u_long shift,GsOT *otp);
...
extern u_long *GsTMDfastTG4LM(TMD_P_TG4 *primtop,SVECTOR *vertop,
        SVECTOR *nortop, POLY_GT4 *s,u_long n,u_long shift,GsOT *otp);
extern u_long *GsTMDfastTG4LFGM(TMD_P_TG4 *primtop,SVECTOR *vertop,
        SVECTOR *nortop,POLY_GT4 *s,u_long n,u_long shift,GsOT *otp);
extern u_long *GsTMDfastTG4NLM(TMD_P_TG4 *primtop,SVECTOR *vertop,
        SVECTOR *nortop,POLY_GT4 *s,u_long n,u_long shift,GsOT *otp);
extern u_long *GsTMDfastTNG4M(TMD_P_TNG4 *primtop,SVECTOR *vertop,
        POLY_GT4 *s,u_long n,u_long shift,GsOT *otp);
...
extern u_long *GsTMDdivTF4LM(TMD_P_TF4 *primtop,SVECTOR *vertop,SVECTOR *nortop,
        POLY_FT4 *s,u_long n,u_long shift,GsOT *otp,DIVPOLYGON4 *divp);
extern u_long *GsTMDdivTF4LFGM(TMD_P_TF4 *primtop,SVECTOR *vertop,
        SVECTOR *nortop,POLY_FT4 *s,u_long n,u_long shift,
        GsOT *otp,DIVPOLYGON4 *divp);
extern u_long *GsTMDdivTF4NLM(TMD_P_TF4 *primtop,SVECTOR *vertop,
        SVECTOR *nortop,POLY_FT4 *s,u_long n,u_long shift,GsOT *otp,
        DIVPOLYGON4 *divp);
extern u_long *GsTMDdivTNF4M(TMD_P_TNF4 *primtop,SVECTOR *vertop,
        POLY_FT4 *s,u_long n,u_long shift,GsOT *otp,DIVPOLYGON4 *divp);
...
extern u_long *GsTMDdivTG4LM(TMD_P_TG4 *primtop,SVECTOR *vertop,SVECTOR *nortop,
        POLY_GT4 *s,u_long n,u_long shift,GsOT *otp,DIVPOLYGON4 *divp);
extern u_long *GsTMDdivTG4LFGM(TMD_P_TG4 *primtop,SVECTOR *vertop,
        SVECTOR *nortop,POLY_GT4 *s,u_long n,u_long shift,
        GsOT *otp,DIVPOLYGON4 *divp);
extern u_long *GsTMDdivTG4NLM(TMD_P_TG4 *primtop,SVECTOR *vertop,
        SVECTOR *nortop,POLY_GT4 *s,u_long n,u_long shift,GsOT *otp,
        DIVPOLYGON4 *divp);
extern u_long *GsTMDdivTNG4M(TMD_P_TNG4 *primtop,SVECTOR *vertop,
        POLY_GT4 *s,u_long n,u_long shift,GsOT *otp,DIVPOLYGON4 *divp);

extern u_long *GsTMDfastF3LB(TMD_P_F3 *primtop,SVECTOR *vertop,SVECTOR *nortop,
        POLY_F3 *s,u_long n,u_long shift,GsOT *otp);
extern u_long *GsTMDfastF3LFGB(TMD_P_F3 *primtop,SVECTOR *vertop,SVECTOR
*nortop, POLY_F3 *s,u_long n,u_long shift,GsOT *otp); extern u_long
*GsTMDfastF3NLB(TMD_P_F3 *primtop,SVECTOR *vertop,SVECTOR *nortop, POLY_F3
*s,u_long n,u_long shift,GsOT *otp); extern u_long *GsTMDfastNF3B(TMD_P_NF3
*primtop,SVECTOR *vertop, POLY_F3 *s,u_long n,u_long shift,GsOT *otp);

extern u_long *GsTMDfastF4LB(TMD_P_F4 *primtop,SVECTOR *vertop,SVECTOR *nortop,
        POLY_F4 *s,u_long n,u_long shift,GsOT *otp);
extern u_long *GsTMDfastF4LFGB(TMD_P_F4 *primtop,SVECTOR *vertop,SVECTOR
*nortop, POLY_F4 *s,u_long n,u_long shift,GsOT *otp); extern u_long
*GsTMDfastF4NLB(TMD_P_F4 *primtop,SVECTOR *vertop,SVECTOR *nortop, POLY_F4
*s,u_long n,u_long shift,GsOT *otp); extern u_long *GsTMDfastNF4B(TMD_P_NF4
*primtop,SVECTOR *vertop, POLY_F4 *s,u_long n,u_long shift,GsOT *otp);

extern u_long *GsTMDfastTF3LB(TMD_P_TF3 *primtop,SVECTOR *vertop,SVECTOR
*nortop, POLY_FT3 *s,u_long n,u_long shift,GsOT *otp); extern u_long
*GsTMDfastTF3LFGB(TMD_P_TF3 *primtop,SVECTOR *vertop, SVECTOR *nortop,POLY_FT3
*s,u_long n,u_long shift,GsOT *otp); extern u_long *GsTMDfastTF3NLB(TMD_P_TF3
*primtop,SVECTOR *vertop, SVECTOR *nortop,POLY_FT3 *s,u_long n,u_long shift,GsOT
*otp); extern u_long *GsTMDfastTNF3B(TMD_P_TNF3 *primtop,SVECTOR *vertop,
        POLY_FT3 *s,u_long n,u_long shift,GsOT *otp);

extern u_long *GsTMDfastTF4LB(TMD_P_TF4 *primtop,SVECTOR *vertop,SVECTOR
*nortop, POLY_FT4 *s,u_long n,u_long shift,GsOT *otp); extern u_long
*GsTMDfastTF4LFGB(TMD_P_TF4 *primtop,SVECTOR *vertop, SVECTOR *nortop,POLY_FT4
*s,u_long n,u_long shift,GsOT *otp); extern u_long *GsTMDfastTF4NLB(TMD_P_TF4
*primtop,SVECTOR *vertop, SVECTOR *nortop,POLY_FT4 *s,u_long n,u_long shift,GsOT
*otp); extern u_long *GsTMDfastTNF4B(TMD_P_TNF4 *primtop,SVECTOR *vertop,
        POLY_FT4 *s,u_long n,u_long shift,GsOT *otp);

extern u_long *GsTMDfastG3LB(TMD_P_G3 *primtop,SVECTOR *vertop,SVECTOR *nortop,
        POLY_G3 *s,u_long n,u_long shift,GsOT *otp);
extern u_long *GsTMDfastG3LFGB(TMD_P_G3 *primtop,SVECTOR *vertop,SVECTOR
*nortop, POLY_G3 *s,u_long n,u_long shift,GsOT *otp); extern u_long
*GsTMDfastG3NLB(TMD_P_G3 *primtop,SVECTOR *vertop,SVECTOR *nortop, POLY_G3
*s,u_long n,u_long shift,GsOT *otp); extern u_long *GsTMDfastNG3B(TMD_P_NG3
*primtop,SVECTOR *vertop, POLY_G3 *s,u_long n,u_long shift,GsOT *otp);

extern u_long *GsTMDfastG4LB(TMD_P_G4 *primtop,SVECTOR *vertop,SVECTOR *nortop,
        POLY_G4 *s,u_long n,u_long shift,GsOT *otp);
extern u_long *GsTMDfastG4LFGB(TMD_P_G4 *primtop,SVECTOR *vertop,SVECTOR
*nortop, POLY_G4 *s,u_long n,u_long shift,GsOT *otp); extern u_long
*GsTMDfastG4NLB(TMD_P_G4 *primtop,SVECTOR *vertop,SVECTOR *nortop, POLY_G4
*s,u_long n,u_long shift,GsOT *otp); extern u_long *GsTMDfastNG4B(TMD_P_NG4
*primtop,SVECTOR *vertop, POLY_G4 *s,u_long n,u_long shift,GsOT *otp);

extern u_long *GsTMDfastTG3LB(TMD_P_TG3 *primtop,SVECTOR *vertop,SVECTOR
*nortop, POLY_GT3 *s,u_long n,u_long shift,GsOT *otp); extern u_long
*GsTMDfastTG3LFGB(TMD_P_TG3 *primtop,SVECTOR *vertop, SVECTOR *nortop,POLY_GT3
*s,u_long n,u_long shift,GsOT *otp); extern u_long *GsTMDfastTG3NLB(TMD_P_TG3
*primtop,SVECTOR *vertop, SVECTOR *nortop,POLY_GT3 *s,u_long n,u_long shift,GsOT
*otp); extern u_long *GsTMDfastTNG3B(TMD_P_TNG3 *primtop,SVECTOR *vertop,
        POLY_GT3 *s,u_long n,u_long shift,GsOT *otp);

extern u_long *GsTMDfastTG4LB(TMD_P_TG4 *primtop,SVECTOR *vertop,SVECTOR
*nortop, POLY_GT4 *s,u_long n,u_long shift,GsOT *otp); extern u_long
*GsTMDfastTG4LFGB(TMD_P_TG4 *primtop,SVECTOR *vertop, SVECTOR *nortop,POLY_GT4
*s,u_long n,u_long shift,GsOT *otp); extern u_long *GsTMDfastTG4NLB(TMD_P_TG4
*primtop,SVECTOR *vertop, SVECTOR *nortop,POLY_GT4 *s,u_long n,u_long shift,GsOT
*otp); extern u_long *GsTMDfastTNG4B(TMD_P_TNG4 *primtop,SVECTOR *vertop,
        POLY_GT4 *s,u_long n,u_long shift,GsOT *otp);
...
extern u_long *GsTMDdivTF3LFGB(TMD_P_TF3 *primtop,SVECTOR *vertop,
        SVECTOR *nortop,POLY_FT3 *s,u_long n,u_long shift,
        GsOT *otp,DIVPOLYGON3 *divp);
extern u_long *GsTMDdivTF3NLB(TMD_P_TF3 *primtop,SVECTOR *vertop,SVECTOR
*nortop, POLY_FT3 *s,u_long n,u_long shift,GsOT *otp,DIVPOLYGON3 *divp); extern
u_long *GsTMDdivTNF3B(TMD_P_TNF3 *primtop,SVECTOR *vertop, POLY_FT3 *s,u_long
n,u_long shift,GsOT *otp,DIVPOLYGON3 *divp);
...
extern u_long *GsTMDdivTF4LFGB(TMD_P_TF4 *primtop,SVECTOR *vertop,
        SVECTOR *nortop,POLY_FT4 *s,u_long n,u_long shift,
        GsOT *otp,DIVPOLYGON4 *divp);
extern u_long *GsTMDdivTF4NLB(TMD_P_TF4 *primtop,SVECTOR *vertop,SVECTOR
*nortop, POLY_FT4 *s,u_long n,u_long shift,GsOT *otp,DIVPOLYGON4 *divp); extern
u_long *GsTMDdivTNF4B(TMD_P_TNF4 *primtop,SVECTOR *vertop, POLY_FT4 *s,u_long
n,u_long shift,GsOT *otp,DIVPOLYGON4 *divp);
...
extern u_long *GsTMDdivTG3LFGB(TMD_P_TG3 *primtop,SVECTOR *vertop,
        SVECTOR *nortop,POLY_GT3 *s,u_long n,u_long shift,
        GsOT *otp,DIVPOLYGON3 *divp);
extern u_long *GsTMDdivTG3NLB(TMD_P_TG3 *primtop,SVECTOR *vertop,SVECTOR
*nortop, POLY_GT3 *s,u_long n,u_long shift,GsOT *otp,DIVPOLYGON3 *divp); extern
u_long *GsTMDdivTNG3B(TMD_P_TNG3 *primtop,SVECTOR *vertop, POLY_GT3 *s,u_long
n,u_long shift,GsOT *otp,DIVPOLYGON3 *divp);
...
extern u_long *GsTMDdivTG4LFGB(TMD_P_TG4 *primtop,SVECTOR *vertop,
        SVECTOR *nortop,POLY_GT4 *s,u_long n,u_long shift,
        GsOT *otp,DIVPOLYGON4 *divp);
extern u_long *GsTMDdivTG4NLB(TMD_P_TG4 *primtop,SVECTOR *vertop,SVECTOR
*nortop, POLY_GT4 *s,u_long n,u_long shift,GsOT *otp,DIVPOLYGON4 *divp); extern
u_long *GsTMDdivTNG4B(TMD_P_TNG4 *primtop,SVECTOR *vertop, POLY_GT4 *s,u_long
n,u_long shift,GsOT *otp,DIVPOLYGON4 *divp);

*/

extern void RotSMD_F3(long* pa, u_long* ot, int otlen, int id, int sclip,
                      int hclip, int vclip, int nclipmode);
extern void RotSMD_G3(long* pa, u_long* ot, int otlen, int id, int sclip,
                      int hclip, int vclip, int nclipmode);
extern void RotSMD_FT3(long* pa, u_long* ot, int otlen, int id, int sclip,
                       int hclip, int vclip, int nclipmode);
extern void RotSMD_GT3(long* pa, u_long* ot, int otlen, int id, int sclip,
                       int hclip, int vclip, int nclipmode);
extern void RotSMD_F4(long* pa, u_long* ot, int otlen, int id, int sclip,
                      int hclip, int vclip, int nclipmode);
extern void RotSMD_G4(long* pa, u_long* ot, int otlen, int id, int sclip,
                      int hclip, int vclip, int nclipmode);
extern void RotSMD_FT4(long* pa, u_long* ot, int otlen, int id, int sclip,
                       int hclip, int vclip, int nclipmode);
extern void RotSMD_GT4(long* pa, u_long* ot, int otlen, int id, int sclip,
                       int hclip, int vclip, int nclipmode);
...
extern void RotRMD_F3(long* pa, u_long* ot, int otlen, int id, int sclip,
                      int hclip, int vclip, int nclipmode);
extern void RotRMD_G3(long* pa, u_long* ot, int otlen, int id, int sclip,
                      int hclip, int vclip, int nclipmode);
extern void RotRMD_FT3(long* pa, u_long* ot, int otlen, int id, int sclip,
                       int hclip, int vclip, int nclipmode);
extern void RotRMD_GT3(long* pa, u_long* ot, int otlen, int id, int sclip,
                       int hclip, int vclip, int nclipmode);
extern void RotRMD_F4(long* pa, u_long* ot, int otlen, int id, int sclip,
                      int hclip, int vclip, int nclipmode);
extern void RotRMD_G4(long* pa, u_long* ot, int otlen, int id, int sclip,
                      int hclip, int vclip, int nclipmode);
extern void RotRMD_FT4(long* pa, u_long* ot, int otlen, int id, int sclip,
                       int hclip, int vclip, int nclipmode);
extern void RotRMD_GT4(long* pa, u_long* ot, int otlen, int id, int sclip,
                       int hclip, int vclip, int nclipmode);
